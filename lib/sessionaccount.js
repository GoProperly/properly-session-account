...
const STAGING_DEFAULT_RETURN_LOCATION = "https://www.admin.goproperly.com/";

const STAGING_RETURN_AFTER_SIGNOUT = "https://www.admin.goproperly.com/";
...
const STAGING_SIGNIN_REDIRECT_URI = "https://staging.admin.goproperly.com:9000/nc/loginhandler.html";
const STAGING_SIGNOUT_REDIRECT_URI = "https://staging.admin.goproperly.com:9000/nc/signout.html";
...
export class SessionAccount {
        ...
        this.auth.userhandler = {
            onSuccess: (result) => {
                ...
                if (this.operatingInHandleLoginContext) {
                    ...
                    if (!redirectLocation) {
                        window.location.href = STAGING_DEFAULT_RETURN_LOCATION;
                    }
                    else {
    ...
    callFromSignoutOnly(){
        ...
        window.location.href = STAGING_RETURN_AFTER_SIGNOUT;
    }
