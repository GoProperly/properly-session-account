...
let initAWS = (useStagingFlag)=> {
    ...
    gSingletonSession.auth = new AWS.CognitoIdentityServiceProvider.CognitoAuth(authData);


    gSingletonSession.auth.userhandler = {
...
export var SessionAccountFactory = {
     sessionAccountInit: (idGeneratorFunction, useStagingFlag)=> {
         ...
         else
         {
             ...
             document.domain = "goproperly.com";

             initAWS(useStagingFlag);
